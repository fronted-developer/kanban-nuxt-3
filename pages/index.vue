<template>
  <main class="pb-72">
    <!-- HERO SECTION -->
    <section
      class="flex items-center justify-between h-[100vh] pt-[10vh] gap-4 bg-gradient-to-t from-white dark:from-black to-blue-500 dark:to-blue-800 pr-10"
    >
      ...
      <NuxtImg src="/hero.webp" height="388" width="802" />
    </section>
            ...
            <div class="flex flex-col mt-4">
              ...
              >
                ...
                <div class="flex flex-col space-y-2">
                  ...
                  <div
                    class="group flex items-center hover:underline gap-1"
                    role="button"
                  >
